...
\textbf{Narración y \emph{hierofanías.} Un diálogo entre la literatura y la religión }

\textbf{Isabel Maldonado Cepeda }
...
\setcounter{enumi}{1}
\item
  \textbf{Lo mítico y lo ritual como manifestación de lo sacro }
\end{enumerate}
...
\setcounter{enumi}{2}
\item
  \textbf{El mito como \emph{hierofanía}}
\end{enumerate}
...
\setcounter{enumi}{3}
\item
  \textbf{El rito como \emph{hierofanía} }
\end{enumerate}
...
Durkheim, É. (1982). \emph{Las formas elementales de la vida religiosa .} Madrid: Akal Editor.

Eagleton, T. (1994). \emph{Una introducción a la teoría literaria .} México D.F: Fondo de Cultura Económica.

Eliade, M. (1967). \emph{Lo sagrado y lo profano .} Madrid: Ediciones Guadarrama.

Eliade, M. (1989). \emph{Th Sacred and the Profane .} New York: Harcourt, Inc.

Eliade, M. (2006). \emph{Mito y Realidad .} Barcelona : Kairós.

Wellek, R. y Warren, A. (2002). Teoría literaria (4ª ed.). Madrid: Gredos.
