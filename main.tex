...
\definecolor{principal}{rgb}{0.15, 0.15, 0.25}
...
\color{principal}
\renewcommand\thefootnote{\textcolor{ehAzul1}{\footnotesize{\arabic{footnote}}}}
...
\normalsize					% La tipografía normal del documento es
