...
\definecolor{ehAzul2}{rgb}{0.65,0.75,0.95}		% Azul claro
...
%		{\vspace{0.5cm}\large *~~~~~*~~~~~*\vspace{0.5cm}}
		{\textcolor{ehAzul2}{\vspace{1cm}\large $\diamond$$\diamond$$\rightarrow$$\diamond$$\diamond$$\diamond$$\diamond$$\diamond$$\diamond$$\diamond$$\diamond$\vspace{-1cm}}}
	\end{center}
}
